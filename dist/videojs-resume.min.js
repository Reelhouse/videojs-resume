...
var Resume = function Resume(options) {
  ...
  if (!_store2['default']) return console.error('store.js is not available');
  if (!_store2['default'].enabled) return console.error('Local storage is not supported by your browser. Please disable "Private Mode", or upgrade to a modern browser.');
  ...
  player.on('timeupdate', function () {
    _store2['default'].set(key, player.currentTime());
  });
